...
- `workbench-1.bren.ucsb.edu` -> 128.111.??.?? (Can you check!?)
...
- `5xx`: Server Error; you might have encounter the 503.. server is down :/ 
...
REST stands for _Representational State Transfer_.  Those APIs have some similarities:
...
`httr2` is an R package that let's you send requests to web services.  Let's try to use the GitHub API to list all my repositories
...
### Note that debugging code relying on an API is hard!!
...
Repository: https://github.com/EDS-214/eds214-handson-api
